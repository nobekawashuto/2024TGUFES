    ...
    return (
        <>
            ...
            <div className="form">
                ...
                <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSfjF323wIrtSpGqskZvbwpKUcJ3awSWDold6NuQThxHRTkaOw/viewform?embedded=true" className="goo-form" width={600} height={900} >読み込んでいます…</iframe>
            </div>
            <Footer />
        </>
