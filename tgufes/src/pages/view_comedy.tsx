                ...
                <ScrollRevealContainer>
                    <div className="yokonarabi">
                        ...
                        <div className="explanation">
                            ...
                            <p className="txt isiyama-deil">第36回ジュノン・スーパーボーイコンテスト　グランプリ受賞。<br/>15155人の頂点に輝く<br/>小学校２年生から高校卒業までサッカー中心の生活を送る。小学5年生の時にスペインレアル・マドリードでの練習に参加。<br/>高校最後の選手権で宮城県大会準優勝メンバー。<br/>大学進学と同時に上京。俳優を目指す。<br/>2024年7月期ドラマ　テレビ朝日系　金曜ナイトドラマ「伝説の頭(ヘッド) 翔」　小見田 信造  役</p>
                            <p className="txt comedy-deil">トークショー</p>
