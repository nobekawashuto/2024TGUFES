      ...
      <div className="bg-access">
        <div className="access">
          ...
          <div className="acc-detail">
            ...
            <iframe src="https://www.google.com/maps/d/embed?mid=1mKLIZZelSfsjVc5-htYi_bN1Zdk63_I&ehbc=2E312F" width={600}height={450}allowFullScreen=""loading="lazy"referrerpolicy="no-referrer-when-downgrade"className="goo-map"></iframe>
          </div>
        </div>
      </div>
